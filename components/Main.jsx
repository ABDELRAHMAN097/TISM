...
const Main = () => {
  ...
  return (
    ...
    >
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
        <div className='w-auto bg-gray-500 bg-opacity-40 rounded-xl px-4'>
          ...
          <div className='flex items-center justify-between max-w-[330px] m-auto py-4'>
           {/* social links */}
             <div className='rounded-full shadow-lg shadow-gray-400 bg-yellow-500 p-4 cursor-pointer hover:scale-110 ease-in duration-300' onClick={handleWhatsAppClick}>
                <FaWhatsapp />
             </div>
            <a
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#000000" fillOpacity="1" d="M0,128L60,112C120,96,240,64,360,48C480,32,600,32,720,42.7C840,53,960,75,1080,80C1200,85,1320,75,1380,69.3L1440,64L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"></path></svg> 
    </div>
  );
};
